<div id="menu" class="closed">
    ...
    <div class="logo">
      ...
      <div class="my-social">
          <ul>
            <li><a href="" target="_blank"><img src="images/icon-fb-footer.png" alt="FB"></a></li>
            <li><a href="" target="_blank"><img src="images/icon-google-footer.png" alt="G+"></a></li>
            <li><a href="" target="_blank"><img src="images/icon-twitter-footer.png" alt="TW"></a></li>
            <li><a href="" target="_blank"><img src="images/icon-linkedin-footer.png" alt="LI"></a></li>        
          </ul>
          <p>Copyright &copy; <?= date("Y") ?> <a href="" target="_blank"></a> All Rights Reserved.</p>
      </div>
</div>