<div id="menu" class="closed">
    ...
    <div class="logo">
      ...
      <div class="my-social">
          <ul>
            <li><a href="https://www.facebook.com/pages//1556884104589980?fref=ts" target="_blank"><img src="images/icon-fb-footer.png" alt="FB"></a></li>
            ...
            <li><a href="https://www.linkedin.com/company/" target="_blank"><img src="images/icon-linkedin-footer.png" alt="LI"></a></li>        
          </ul>
          <p>Copyright &copy; <?= date("Y") ?> <a href="http://www.ozoneplay.com/" target="_blank"></a> All Rights Reserved.</p>
      </div>
</div>