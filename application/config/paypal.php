 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'kamililyas_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'VFX4JPVESHQKYMXG' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'Anx9ncNAJDa2g0xhCZTH7w1stQ3RAzlow.UQ20W-nKucBhRvhif7Ka.l' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'khadim.nu@gmail.com';
